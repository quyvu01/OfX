...
/// Use the generic <see cref="IMappableRequestHandler{TAttribute}"/> for actual implementation.
/// </remarks>
...
/// <summary>
/// Default no-op implementation of <see cref="IMappableRequestHandler{TAttribute}"/>.
/// </summary>
/// <typeparam name="TAttribute">
/// The type of <see cref="OfXAttribute"/> representing the model or entity being requested.
/// </typeparam>
