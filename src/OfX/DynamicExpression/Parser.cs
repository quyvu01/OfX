...
//             throw ParseException.Create(errorPos, ErrorMessages.AmbiguousUnaryOperatorInvocation, operatorName,
...
//                 else
//                     throw ParseException.Create(tokenPos, ErrorMessages.InvalidMethodCall,
...
//         if (member == null)
//         {
//             throw ParseException.Create(pos, ErrorMessages.UnknownPropertyOrField, propertyOrFieldName,
...
//         if (!allowCollectionInit)
//         {
//             throw ParseException.Create(_token.pos, ErrorMessages.CollectionInitializationNotSupported, newType,
//                 typeof(IEnumerable));
//         }
//
//         if (bindingList.Count > 0)
...
//                 ErrorMessages.OpenCurlyBracketExpected, TokenId.CloseCurlyBracket,
//                 ErrorMessages.CloseCurlyBracketExpected));
//         }
//         else
//         {
...
//             if (addMethod == null)
//             {
//                 throw ParseException.Create(_token.pos, ErrorMessages.UnableToFindAppropriateAddMethod,
//                     TypeUtils.GetTypeName(newType));
//             }
//
...
//                     candidates.Where(_ => _.Method.GetParameters().Length == args.Length).ToList();
...
//
//         throw ParseException.Create(errorPos, ErrorMessages.UnknownPropertyOrField, propertyOrFieldName,
//             TypeUtils.GetTypeName(type));
//     }
//
...
//             ErrorMessages.OpenParenExpected, TokenId.CloseParen, ErrorMessages.CloseParenOrCommaExpected);
//     }
//
//     private Expression ParseMethodInvocation(Type type, Expression instance, int errorPos, string methodName,
...
//             throw ParseException.Create(errorPos, ErrorMessages.AmbiguousMethodInvocation, methodName,
//                 TypeUtils.GetTypeName(type));
//
//         if (extensionMethods.Count == 1)
//         {
...
//             dynamicExpression.Arguments.Concat(new[] { value }));
//         return true;
//     }
//
...
//             ErrorMessages.AmbiguousBinaryOperatorInvocation, operatorName, TypeUtils.GetTypeName(leftType),
...
//                     if (_defaultNumberType == DefaultNumberType.Single ||
//                         _defaultNumberType == DefaultNumberType.Double ||
//                         _defaultNumberType == DefaultNumberType.Decimal)
//                     {
//                         t = TokenId.RealLiteral;
//                     }
//                     else
...
//                     }
//
//                     if (canBeRealLiteral && (_parseChar == 'D' || _parseChar == 'd' || _parseChar == 'F' ||
//                                              _parseChar == 'f' || _parseChar == 'M' || _parseChar == 'm'))
//                     {
//                         t = TokenId.RealLiteral;
//                         NextChar();
//                     }
