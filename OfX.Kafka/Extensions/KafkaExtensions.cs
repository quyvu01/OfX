...
{
    public static void AddKafka(this OfXRegister ofXRegister, Action<KafkaMqConfigurator> options)
    {
        var config = new KafkaMqConfigurator();
    ...
    public static void StartKafkaMqListeningAsync(this IHost host)
    {
